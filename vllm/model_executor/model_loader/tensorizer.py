...
from vllm.model_executor.layers.quantization.base_config import (
    QuantizeMethodBase)# TENSORIZER_ADD
from vllm.model_executor.model_loader import loader# TENSORIZER_ADD
    ...
    def deserialize(self):
        ...
        for name, module in self.model.named_modules(): # TENSORIZER_ADD
            ...
            if isinstance(quant_method, QuantizeMethodBase):
                with loader.device_loading_context(module, next(module.parameters()).device):
